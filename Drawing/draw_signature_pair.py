...
def main():
    ...
    matching_file = "result/data" + args[1] + '/figure/' + args[2] +"_signature/matching.txt"
    ...
    while(i < K*2-1):
        ...
        j += 1
    matching.close()
    df_file = "result/data" + args[1] + '/figure/' + args[2] +"_signature/df.csv"
    ...
    for i in range(K):
        ...
        dataframe.write(str(i+1) + ' (mutation),')
        for j in range(96):
    ...
    for i in range(0,K*2,2):
        ...
        fig.tight_layout()
        name = 'result/data'+ args[1] + '/figure/' + args[2] + '_signature/' + str((i+1)//2 + 1) + '_match.png'
