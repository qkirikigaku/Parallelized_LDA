...
args = sys.argv
"""args[1]:data_type [2]:number_of_topic [3]:threshold number word [4]:cancer_type"""
K = int(args[2])
...
if(args[1] == '1'):
    ...
    if(len(args) == 5):
        input_file += '_' + args[4] +'/result_k' + topic + '.txt'
    else:
        input_file += '/result_k' + topic + '.txt'
else:
    input_file = 'result/data' + args[1] + '_o' + args[3]
    if(len(args) == 5):
        input_file += '_' + args[4] + '/figure/' + args[2] + '/k' + topic + '.txt'
    else:
        input_file += '/figure/' + args[2] + '/k' + topic + '.txt'
...
if(len(args) == 5):
    matching_file = "result/data" + args[1] + '_o' + args[3] + '_' + args[4] +'/figure/' + args[2] +"/matching.txt"
else:
    matching_file = "result/data" + args[1] + '_o' + args[3] + '/figure/' + args[2] +"/matching.txt"
...
matching.close()
if(len(args) == 5):
    df_file = "result/data" + args[1] + '_o' + args[3] + '_' + args[4] +'/figure/' + args[2] +"/df.csv"
else:
    df_file = "result/data" + args[1] + '_o' + args[3] + '/figure/' + args[2] +"/df.csv"
...
for i in range(0,K*2,2):
    ...
    fig.tight_layout()
    if(len(args) == 5):
        name = 'result/data'+ args[1] + '_o' + args[3] + '_' + args[4] + '/figure/' + args[2] + '/predicted_' + str((i+1)//2 + 1) + '.png'
    else:
        name = 'result/data'+ args[1] + '_o' + args[3] + '/figure/' + args[2] + '/' + str((i+1)//2 + 1) + '_match.png'
